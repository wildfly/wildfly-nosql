...
public class CustomModuleTestCase {
    ...
    public void jndiLookup() throws Exception {
        Object value = iniCtx.lookup("java:jboss/neo4jdriver/test");
        if (value == null) {
              dumpJndi("java:jboss/neo4jdriver/test");
        }
        assertTrue(value instanceof Driver);
    }
    ...
    public void testSimpleCreateAndLoadEntities() throws Exception {
        ...
        String person = statefulTestBean.addPerson();
        assertTrue(person + " contains \"Arthur\"", person.contains("Arthur"));
        String cdi = statefulTestBean.addPersonClassInstanceInjection();
        assertTrue(cdi + " contains \"CDI\"", cdi.contains("CDI"));
    }
    ...
    public void testHasTestModuleSlot() throws Exception {
        ...
        assertTrue(classLoaderName + " contains module org.neo4j.driver:test : " + classLoaderName, classLoaderName.contains("org.neo4j.driver:test"));
    }
